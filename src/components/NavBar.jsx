const NavBar = (props) => {
    return ( 
        <nav>
            ...
            <div>
                <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" className="home-nav-icon">
                ...
                <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" className="movie-nav-icon">
                ...
                <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" className="tv-series-nav-icon">
                ...
                <svg width="17" height="20" xmlns="http://www.w3.org/2000/svg" className="bookmark-nav-icon">
            ...
            <img src="./images/icons/image-avatar.png" alt="user profile" />
        </nav>
     );
}
